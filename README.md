...
* The upload page, where you can upload your genome and provide your contact email address.
<img src="/imgs/sfig7b.png" alt="upload genome"  width="700">

* This might take a few seconds to upload and clean the file. After it's done, you will see the message at the bottom.
<img src="/imgs/sfig7c.png" alt="genome uploaded"  width="700">

* After around 30 minutes, you will receive an email in the mailbox of the email address you provided. The 50 digits token is used for the GNPS, which will be explain in the next step. Also, you will receive the link to download the BGCs, ORFs, cores, and the molecules in SMILES format.
...
* In advanced options, please fill out the custom DB URL with the 50 digit token.
<img src="/imgs/sfig7e.png" alt="db link"  width="700">

* After a few hours, you will receive an email from GNPS, and the link to the result.
<img src="/imgs/sfig7f.png" alt="GNPS results"  width="700">




## About the hypoNPAtlas server
